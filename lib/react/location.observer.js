...
var doIsOnceSuccess = function doIsOnceSuccess() {
  var beforeStatus = arguments.length <= 0 || arguments[0] === undefined ? '' : arguments[0];
  return function (status) {
    if (status == _actions.types.LOCATE_SUCCESS && beforeStatus != status) {
      beforeStatus = status;
      return true;
    }
    beforeStatus = status;
...
var LocationObserver = function (_React$Component) {
  ...
  _createClass(LocationObserver, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var location = (0, _select.select)(nextProps);
