...
var LocationButton = function (_React$Component) {
  ...
  function LocationButton(props, context) {
    ...
    _this.onTouchTap = function () {
      _reduxManager.manager.dispatch(_reduxLocation.locationActions.locateDelayed({ delay: 2000 }), _this.state.serviceName);
  ...
  _createClass(LocationButton, [{
    ...
    value: function componentDidMount() {
      _reduxManager.manager.dispatch(_reduxLocation.locationActions.locateDelayed({ check: true, delay: 2000 }), this.state.serviceName);
    }
  }, {
