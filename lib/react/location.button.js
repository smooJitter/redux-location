...
var LocationButton = function (_React$Component) {
  ...
  function LocationButton(props, context) {
    ...
    var serviceName = _props$serviceName === undefined ? 'location' : _props$serviceName;
  ...
  _createClass(LocationButton, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        { tooltip: this.state.textLocation, onClick: this.request },
...
LocationButton.propTypes = { serviceName: _react.PropTypes.string };
